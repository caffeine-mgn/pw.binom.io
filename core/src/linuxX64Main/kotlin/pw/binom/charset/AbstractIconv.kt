...
abstract class AbstractIconv(fromCharset: String, toCharset: String) : Closeable {
    ...
    protected fun iconv(input: ByteBuffer, output: ByteBuffer): CharsetTransformResult {
        ...
        memScoped {
            ...
            return when {
                r != 0uL && errno == E2BIG -> CharsetTransformResult.OUTPUT_OVER
                r != 0uL && errno == EILSEQ -> CharsetTransformResult.MALFORMED
                r != 0uL && errno == EINVAL -> CharsetTransformResult.INPUT_OVER
                r == 0uL && errno == 0 -> CharsetTransformResult.SUCCESS
