...
fun <U> FileSystemAccess.Companion.fullAccess(): FileSystemAccess<U> =
    PrivateFullAccessFileSystemAccess as FileSystemAccess<U>

/**
 * Returns FileSystemAccess that disallow all Access
 */
@Suppress("UNCHECKED_CAST")
fun <U> FileSystemAccess.Companion.forbidden(): FileSystemAccess<U> =
    PrivateForbiddenFileSystemAccess as FileSystemAccess<U>
