...
fun FileSystem.withDefaultUser(user: Any) =
  when {
    ...
    this is FileSystemWithDefaultUser && this.user != user -> throw IllegalArgumentException(
      "File system already use user ${this.user}",
    )
