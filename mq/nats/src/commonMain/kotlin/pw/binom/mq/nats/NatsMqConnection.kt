...
class NatsMqConnection(val reader: NatsReader) : MqConnection {
  ...
  override suspend fun createTopic(name: String): Topic = NatsTopic(connection = this, subject = name)
...
suspend fun MqConnection.Companion.nats(
  ...
  return NatsMqConnection(reader)
}
