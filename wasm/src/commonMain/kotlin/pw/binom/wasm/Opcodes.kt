...
object Opcodes {
  ...
  const val I64_LT_U: UByte = 0x54u// i64.lt_u
  const val I64_GT_S: UByte = 0x55u // i64.gt_s
  const val I64_GT_U: UByte = 0x56u // i64.gt_u
  ...
  const val I64_SUB: UByte = 0x7du// i64.sub
  ...
  const val I64_ROTL: UByte = 0x89u // i64.rotl
  const val I64_ROTR: UByte = 0x8au// i64.rotr
  const val F32_ABS: UByte = 0x8bu // f32.abs
  const val F32_NEG: UByte = 0x8cu // f32.neg
  const val F32_CEIL: UByte = 0x8du// f32.ceil
  const val F32_FLOOR: UByte = 0x8eu // f32.floor
  const val F32_TRUNC: UByte = 0x8fu // f32.trunc
  const val F32_NEAREST: UByte = 0x90u // f32.nearest
  const val F32_SQRT: UByte = 0x91u// f32.sqrt
  ...
  const val F64_CEIL: UByte = 0x9bu// f64.ceil
  const val F64_FLOOR: UByte = 0x9cu// f64.floor
  const val F64_TRUNC: UByte = 0x9du // f64.trunc
  const val F64_NEAREST: UByte = 0x9eu // f64.nearest
  const val F64_SQRT: UByte = 0x9fu// f64.sqrt
  ...
  const val F64_MIN: UByte = 0xa4u// f64.min
  const val F64_MAX: UByte = 0xa5u// f64.max
