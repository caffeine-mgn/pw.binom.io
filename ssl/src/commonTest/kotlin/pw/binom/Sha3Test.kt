...
import pw.binom.crypto.Sha3MessageDigest
import pw.binom.io.socket.ssl.hexToByteArray
...
class Sha3Test {
    ...
    @Test
    fun tt() {
        val input = "My message!".encodeToByteArray()
...
//            asByte(0xa, 0xd)
//        )
        val d = Sha3MessageDigest(Sha3MessageDigest.Size.S256)
        d.update(input)
        val result = d.finish()
