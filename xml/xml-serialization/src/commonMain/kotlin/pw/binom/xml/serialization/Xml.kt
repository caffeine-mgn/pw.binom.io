...
class Xml(
  ...
  fun <T> encodeToXmlElement(serializer: SerializationStrategy<T>, value: T): XmlElement {
...
//        val v = SyncXmlRootWriterVisitor(sb)
  ...
  fun <T> decodeFromXmlElement(serializer: DeserializationStrategy<T>, xmlElement: XmlElement): T {
  ...
  fun <T> decodeFromString(serializer: DeserializationStrategy<T>, xml: String): T =
