...
//    }
  ...
  override fun set(
    ...
    native.setTimestamp(index + 1, Timestamp(value.milliseconds))
  }
...
//        native.setObject(index + 1, null)
  ...
  override fun executeQuery() = SQLiteResultSet(native.executeQuery())

  override fun executeUpdate(): Long = native.executeUpdate().toLong()
