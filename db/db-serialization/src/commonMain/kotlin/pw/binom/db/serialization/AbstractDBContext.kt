...
abstract class AbstractDBContext : DBContext {
  protected abstract val pool: AsyncConnectionPool
  protected abstract val sql: SQLSerialization
  private val tx by lazy { TransactionManagerImpl(pool) }
  internal val statements = defaultMutableMap<String, SQLQueryNamedArguments>()
  internal val mappers = defaultMutableMap<KSerializer<out Any>, suspend (AsyncResultSet) -> Any>()
