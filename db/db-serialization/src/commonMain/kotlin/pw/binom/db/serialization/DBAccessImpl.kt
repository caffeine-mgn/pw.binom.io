...
internal class DBAccessImpl(
  ...
  override suspend fun <T : Any> find(
    ...
    val idColumn =
      context.getDescription(serializer).id
...
//            )
  ...
  override fun tableName(serializer: KSerializer<out Any>): String = context.getDescription(serializer).fullTableName
