...
class JsBaseHttpClient : HttpClient {
  ...
  override suspend fun connect(method: String, uri: URL): HttpRequest = HttpRequestImpl(
    client = this,
    method = method,
    url = uri
  )
...
class HttpRequestImpl(val client: JsBaseHttpClient, override val method: String, override val url: URL) : HttpRequest {
