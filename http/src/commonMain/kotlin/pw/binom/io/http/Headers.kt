...
interface Headers : Map<String, List<String>> {
  ...
  fun toSimpleHeaders() = SimpleHeaders(this)
...
fun Array<out Pair<String, String>>.toHeaders() = if (isEmpty()) EmptyHeaders else toMutableHeaders()
fun Array<out Pair<String, String>>.toMutableHeaders() = HashHeaders2(this as Array<Pair<String, String>>)
